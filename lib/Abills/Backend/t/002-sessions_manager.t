...
if ( use_ok('Abills::Backend::Plugin::Websocket::SessionsManager') ) {
  require Abills::Backend::Plugin::Websocket::SessionsManager;
  Abills::Backend::Plugin::Websocket::SessionsManager->import();
};


my Abills::Backend::Plugin::Websocket::SessionsManager $adminSessionManager
  = new_ok('Abills::Backend::Plugin::Websocket::SessionsManager',
  [ { CLIENT_CLASS => 'Admin' } ]);
